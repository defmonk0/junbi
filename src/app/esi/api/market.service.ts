...
export class MarketService {
     ...
     * List open market orders placed on behalf of a corporation  --- Alternate route: &#x60;/latest/corporations/{corporation_id}/orders/&#x60;  Alternate route: &#x60;/v2/corporations/{corporation_id}/orders/&#x60;  --- This route is cached for up to 1200 seconds  --- Requires one of the following EVE corporation role(s): Accountant, Trader 
     ...
     * List cancelled and expired market orders placed on behalf of a corporation up to 90 days in the past.  --- Alternate route: &#x60;/latest/corporations/{corporation_id}/orders/history/&#x60;  Alternate route: &#x60;/legacy/corporations/{corporation_id}/orders/history/&#x60;  Alternate route: &#x60;/v1/corporations/{corporation_id}/orders/history/&#x60;  --- This route is cached for up to 3600 seconds  --- Requires one of the following EVE corporation role(s): Accountant, Trader 
     * @param corporationId An EVE corporation ID
     * @param datasource The server name you would like data from
     * @param page Which page of results to return
     * @param token Access token to use if unable to set a header
